...
(function(g){
    ...
    STORE.ValidacionExpresionRegular = {
        ...
        validarDni : function (evt) {
            ...
            if(!STORE.ValidacionExpresionRegular(parametro.patron)){
                ...
                let letra = true; //TODO false parametro.mensajeError = "ERROR: Letra Dni incorrecto";

                STORE.ValidacionUtil.valorarConsecuencia(letra, parametro);
